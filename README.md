...
- [**Breast Cancer Detection:**](https://github.com/sophisticated21/Comperative_Analysis_of_Breast_Cancer_Detection/tree/main) I meticulously compared various machine learning algorithms to ascertain their efficiency in diagnosing breast cancer. Among these, the RandomForestClassifier stood out, demonstrating a notable accuracy of 96%. This finding underscores the algorithm's potent capability in accurately distinguishing between benign and malignant conditions. In addition to the algorithmic comparison, I conducted an in-depth feature importance analysis, pinpointing the most crucial factors for breast cancer detection. This analysis aims to refine diagnostic processes and enhance predictive accuracy. The project leveraged the respected breast cancer dataset curated by professors from the University of Wisconsin, providing a solid basis for our evaluations. This analysis has been thoroughly documented, following scholarly conventions and attributing all sources accurately.
### Marketing
<img src="/assets/img/marketing.jpg" width="1000" height="400">


- **Certificates**: [Customer Marketing Campaigns(DataCamp)](assets/img/Certificate(AnalyzingMarketingCampaigns).png), [Analyzing Social Media Data in Python(DataCamp)](assets/img/Certificate(AnalyzingSocialMediaData).png), [Market Basket Analysis in Python(DataCamp)](assets/img/Certificate(MarketBasketAnalysisInPython).png), [Machine Learning for Marketing(DataCamp)](assets/img/Certificate(MachineLearningForMarketing).png), [Customer Segmentation in Python(DataCamp)](assets/img/Certificate(CustomerSegmentation).png), [Predicting Customer Churn in Python(DataCamp)](assets/img/Certificate(PredictingCustomerChurnInPython).png), [Customer Analytics and A/B Test(DataCamp)](assets/img/Certificate(CustomerAnalytics_ABtest).png), [Marketing Analytics in Python(DataCamp)](assets/img/Certificate(MarketingAnalyticsWithPython).png)
- [**Sales Dynamics and Shipping Efficiency Analysis**](https://github.com/sophisticated21/Sales-Dynamics-and-Shipping-Efficiency-Analysis): In this project, I utilized SQL for data extraction and cleaning, conducted an A/B test in Python to assess the impact of shipping modes on sales, and visualized outcomes using PowerBI. This analysis provided actionable insights into customer purchasing behaviors, guiding data-driven decisions in retail strategy. 
- [**An Analysis of House Ads Campaign Effectiveness**](https://github.com/sophisticated21/An-Analysis-of-House-Ads-Campaign-Effectiveness): I conducted a detailed analysis of our January 2018 marketing campaign data, with a particular focus on evaluating conversion rate trends. This involved retrieving data using SQL queries, conducting initial explorations, and performing data cleaning. I handled the data using Python and emphasized visualization of the conversion rates through Matplotlib to identify any potential declines. My analysis aimed to uncover any contributing factors to changes in conversion rates and understand the underlying causes. I reported my findings and visualized the data using PowerBI(ongoing).
...
### Finance
- **Certificates**: [**Introduction to Python for Finance(DataCamp)**](assets/img/IntroductionToPythonForFinance.png), [**Intermediate Python For Finance(DataCamp)**](assets/img/IntermediatePythonForFinance.png), [**Introduction to Financial Concepts in Python**](assets/img/Certificate(FinancialConceptsInPython).png)
