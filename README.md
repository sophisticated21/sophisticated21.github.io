...
- **[Sales Dynamics and Shipping Efficiency Analysis](https://github.com/sophisticated21/Sales-Dynamics-and-Shipping-Efficiency-Analysis):** In this project, I utilized SQL for data extraction and cleaning, conducted an A/B test in Python to assess the impact of shipping modes on sales, and visualized outcomes using PowerBI. This analysis provided actionable insights into customer purchasing behaviors, guiding data-driven decisions in retail strategy. My work showcases skills in data analysis, statistical testing, and business intelligence.
